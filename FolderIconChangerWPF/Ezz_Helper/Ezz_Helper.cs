...
namespace Ezz_Helper
{
    ...
    /// <summary>
    /// What's the decision if there is same file name in the folder.
    /// </summary>
    /// <remarks></remarks>
    public enum SameFileNameDecisions
    {
        /// <summary>
        /// Skip this file from the operation.
        /// </summary>
        /// <remarks></remarks>
        Skip = 0,
        //
        /// <summary>
        /// Overwrite this file in any case.
        /// </summary>
        /// <remarks></remarks>
        Overwrite = 1,
        /// <summary>
        /// Overwrite this file if the Modified date of the new one is [newer] than current file.
        /// </summary>
        /// <remarks></remarks>
        Overwrite_IfNew = 2,
        /// <summary>
        /// Overwrite this file if the Modified date of the new one is [older] than current file.
        /// </summary>
        /// <remarks></remarks>
        Overwrite_IfOld = 3,
        //
        /// <summary>
        /// Rename this new file in any case.
        /// </summary>
        /// <remarks></remarks>
        Rename = 4,
        /// <summary>
        /// Rename the new file if the Modified date of it is [newer] than current file.
        /// </summary>
        /// <remarks></remarks>
        Rename_IfNew = 5,
        /// <summary>
        /// Rename the new file if the Modified date of it is [older] than current file.
        /// </summary>
        /// <remarks></remarks>
        Rename_IfOld = 6
    }
