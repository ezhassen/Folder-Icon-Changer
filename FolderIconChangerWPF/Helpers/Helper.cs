...
public static partial class NativeMethods
{
    ...
    //public static partial int LockWindowUpdate(IntPtr hWnd);
    ...
    //public static partial IntPtr SHGetFileInfo(string pszPath, uint dwFileAttributes,
    //                                              ref SHFILEINFO psfi, uint cbFileInfo, uint uFlags);



    //[LibraryImport("shell32.dll", StringMarshalling = StringMarshalling.Utf16)]
    //public static partial IntPtr ExtractIcon(IntPtr hInst, string lpszExeFileName, uint nIconIndex);
    ...
    //[DllImport("shell32.dll", CharSet = CharSet.Unicode)]
    //public static extern int PickIconDlg(IntPtr hwndOwner, StringBuilder lpstrFile,
    ...
    public static partial void SHChangeNotify(uint wEventId, uint uFlags, uint dwItem1, uint dwItem2);
    ...
    [DllImport("kernel32.dll", EntryPoint = "GetLongPathNameW", SetLastError = true, CharSet = CharSet.Auto)]
