...
namespace FolderIconChangerWPF.Animation
{
    /// <summary>
    ...
    public static class FrameworkElementAnimations
    {
        ...
        /// <param name="firstLoad">Indicates if this is the first load</param>
        /// <returns></returns>
        public static async Task FadeInAsync(this FrameworkElement element, bool firstLoad, float seconds = 0.3f, bool SetIsHitTestVisibleToFalse = false)
        {
            // Create the storyboard
            var sb = new Storyboard();
            if (SetIsHitTestVisibleToFalse) element.IsHitTestVisible = false;
            // Add fade in animation
            sb.AddFadeIn(seconds);
        ...
        /// <param name="seconds">The time the animation will take</param>
        /// <returns></returns>
        public static async void MarqueeAsync(this FrameworkElement element, float seconds = 3f)
        {
            // Create the storyboard
            var sb = new Storyboard();
