...
namespace FolderIconChangerWPF.Win32
{
    ...
    public static class NativeMethods
    {
        ...
        private static string GetSystemSound(string soundName)
        {
            ...
            set.AddPermission(new RegistryPermission(RegistryPermissionAccess.Read,
        ...
        public static void PlaySound(string soundName)
        {
            ...
            {
                PlaySound(systemSound, IntPtr.Zero,
        ...
        public static IntPtr GetHIcon(ImageSource source)
        {
            ...
            if (frame != null && frame.Decoder != null && frame.Decoder.Frames.Count > 0)
            {
