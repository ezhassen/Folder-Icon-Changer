...
namespace Folder_Icon_Changer
{
    static class Program
    {
        ...
        public static void LoadLang(Action onFinish = null)
        {
            Preloader.Show();
            ...
            else
            {
                ...
                mlm.ReloadLngsInfo();
                var def = mlm.LngsInfo.FirstOrDefault((li) => li.FileName.Equals("english.xml", StringComparison.OrdinalIgnoreCase));
